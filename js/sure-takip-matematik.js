// js/sure-takip-matematik.js - 15 DAKİKA KURALINA UYGUN KESİN ÇÖZÜM
...
function updateDailyProgressUI() {
    ...
    // Rengi Matematiğe göre ayarla (Örneğin: Indigo/Blue)
...
auth.onAuthStateChanged(user => {
    ...
    db.collection(DERS_TAKIP_COLLECTION).doc(userID).get()
        ...
        .catch((error) => {
            console.error("Matematik Veri yüklenirken kritik hata:", error);
